...
## [0.3.25](https://github.com/onestacked/rust-sdks/compare/rust-sdks/libwebrtc@0.3.24...rust-sdks/libwebrtc@0.3.25) - 2026-02-06

### Fixed

- fix the 440->441 samples issue and pass a noop callback for release ([#848](https://github.com/onestacked/rust-sdks/pull/848))

### Other

- Use workspace dependencies & settings ([#856](https://github.com/onestacked/rust-sdks/pull/856))
- allow apm >=10ms frames ([#843](https://github.com/onestacked/rust-sdks/pull/843))
